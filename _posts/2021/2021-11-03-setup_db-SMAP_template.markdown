---
layout: article
title: SMAP_template_v090_sql.json
categories: setup_db
excerpt:  Add the SMAP product templates
tags:: 
    - SMAP_template
date: 2021-11-03
modified: 2021-11-03
...
# SMAP template (setup_db)

###  Add the SMAP product templates

The json command file <span class='file'>SMAP_template_v090_sql.json</span> is part of karttur's GeoImagine project <span class='project'>setup_db</span>. Calling the json file will execute the following commands of the GeoImagine Framework.
        ...
        "command": {
          ...
          "values": [
            ...
            [
              ...
              "'tif'",
              "'polar'",
              "'freeze-thaw_data-sampling-density'",
            ...
            [
              ...
              "'tif'",
              "'polar'",
              "'freeze-thaw_freeze-thaw-time-seconds'",
            ...
            [
              ...
              "'tif'",
              "'polar'",
              "'freeze-thaw_normalized-polarization-ratio'",
            ...
            [
              ...
              "'tif'",
              "'polar'",
              "'freeze-thaw_open-water-body-fraction'",
            ...
            [
              ...
              "'tif'",
              "'polar'",
              "'freeze-thaw_reference-image-threshold'",
            ...
            [
              ...
              "'tif'",
              "'polar'",
              "'freeze-thaw_retrieval-algorithm-flag'",
              "'retrieval_algorithm_flag'",
              "'Freeze_Thaw_Retrieval_Data_Polar'",
              "1",
              "0",
              "'retrieval algorithm flag'",
              "'Boolean that indicates whether the NPR change detection algorithm or the single-channel V-pol threshold algorithm was used to retrieve freeze-thaw state.  A value of 0 indicates the NPR algorithm and a value of 1 indicates the SCV algorithm.'",
              "'retrieval-algorithm-flag'",
              "'N'",
              "'R'",
              "-1",
            ...
            [
              ...
              "'tif'",
              "'polar'",
              "'freeze-thaw_retrieval-qual-flag'",
              "'retrieval_qual_flag'",
              "'Freeze_Thaw_Retrieval_Data_Polar'",
              "1",
              "0",
            ...
            [
              ...
              "'tif'",
              "'polar'",
              "'freeze-thaw_transition-direction'",
            ...
            [
              ...
              "'tif'",
              "'polar'",
              "'freeze-thaw_transition-state-flag'",
        ...
        "command": {
          ...
          "values": [
            ...
            [
              ...
              "0",
              "'retrieval algorithm flag'",
              "'Boolean that indicates whether the NPR change detection algorithm or the single-channel V-pol threshold algorithm was used to retrieve freeze-thaw state.  A value of 0 indicates the NPR algorithm a value of 1 indicates the SCV algorithm.'",
              "'retrieval-algorithm-flag'",
              "'N'",
              "'R'",
              "-1",
        ...
        "command": {
          ...
          "values": [
            ...
            [
              ...
              "0",
              "'albedo'",
              "'Diffuse reflecting power of the Earths surface within the grid cell.'",
              "'albedo'",
              "'N'",
              "'R'",
              "-9999",
            ...
            [
              ...
              "0",
              "'landcover class'",
              "'An enumerated type that specifies the most common landcover class in the grid cell based on the IGBP landcover map. The array order is longitude (ascending) followed by latitude (descending) and followed by descending'",
              "'landcover-class'",
              "'N'",
              "'R'",
              "-9999",
            ...
            [
              ...
              "0",
              "'roughness coefficient'",
              "'A unitless value that is indicative of bare soil roughness within the 36 km grid cell.'",
              "'roughness-coefficient'",
              "'N'",
              "'R'",
              "-9999",
            ...
            [
              ...
              "0",
              "'landcover class pm'",
              "'An enumerated type that specifies the most common landcover class in the grid cell based on the IGBP landcover map. The array order is longitude (ascending) followed by latitude (descending) and followed by IGBP land cover type descending dominance'",
              "'landcover-class-pm'",
              "'N'",
              "'R'",
              "'-1'",
        ...
        "command": {
          ...
          "values": [
            ...
            [
              ...
              "0",
              "'roughness coefficient'",
              "'A unitless value that is indicative of bare soil roughness within the 9 km grid cell.'",
              "'roughness-coefficient'",
              "'N'",
              "'R'",
              "-9999",
        ...
        "command": {
          ...
          "values": [
            ...
            [
              ...
              "'tif'",
              "'global'",
              "'soil-moisture_radar-vegetation-index'",
