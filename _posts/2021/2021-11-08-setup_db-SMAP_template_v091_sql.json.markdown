---
layout: article
title: SMAP_template_v091_sql.json
categories: setup_db
...
# SMAP template v091 sql.json (setup_db)

###  Add the SMAP product templates

The json command file <span class='file'>SMAP_template_v091_sql.json</span> is part of karttur's GeoImagine project <span class='project'>setup_db</span>. Calling the json file will execute the following commands of the GeoImagine Framework.
